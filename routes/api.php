...
Route::put('/v1/auth/user',[AuthController::class,'update_user'])->middleware('auth:sanctum');
...
Route::post('/observation/HeartRate/{id_pasien}',[HearthRateController::class,'store'])->middleware('auth:sanctum');
Route::post('/observation/RespiratoryRate',[ObservationController::class, 'storeRespiratoryRate'] )->middleware('auth:sanctum');
